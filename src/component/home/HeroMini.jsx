...
import { AIPrompt, UserPrompt } from "../../config/AIPrompt";
...
export default function Hero(props) {
  ...
  const [activeTab, setActiveTab] = useState("form"); // "form" or "prompt"
  ...
  // Form-based response generation
  ...
  const getPromptResponse = async (prompt) => {
    try {
      const FinalPrompt = UserPrompt.replace("{prompt}", prompt);
      console.log(FinalPrompt);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const generatedItinerary = await getFormResponse(formData);
  ...
  const handlePromptSubmit = async (e) => {
    ...
    try {
      ...
      const generatedItinerary = await getPromptResponse(searchQuery);
    ...
    <section className="relative text-white py-1">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="flex-1 mb-2 md:mb-0">
                    <div className="flex items-center bg-white rounded p-2">
                      ...
                      <input
                        ...
                        className="w-full min-w-[150px] border-0 focus:ring-0 p-1 text-gray-800"
                        required
                      />
                      {isLoading && (
          ...
          {/* Example Text */}
          <div className="flex items-center justify-center text-sm text-white mt-4">
            <Clock size={16} className="mr-2" />
            <p>
              {activeTab === "form" 
                ? "Use the form above to specify your travel preferences in detail"
                : "Example: 2 days trip to Goa, want to visit places for cool instagram photos"
              }
            </p>
          </div>
        </div>
